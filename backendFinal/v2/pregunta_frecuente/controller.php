...
class Controlador
{
    ...
    public function postNuevo($_nuevoObjeto)
    {
        ...
        $sql = "INSERT INTO pregunta_frecuente (id, pregunta, respuesta, activo) VALUES ($id,'$_nuevoObjeto->nombre', true)";
        // echo $sql;
        //ejecutar sql
        $rs = [];
        try {
    ...
    public function putPreguntaById($_nombre, $_id)
    {
        $con = new Conexion();
        $sql = "UPDATE pregunta_frecuente SET pregunta = '$_nombre' WHERE id = $_id;";
        // echo $sql;
        //ejecutar sql
        $rs = [];
        try {
