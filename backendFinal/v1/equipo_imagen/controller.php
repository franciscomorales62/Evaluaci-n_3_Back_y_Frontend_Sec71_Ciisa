    ...
    public function getAll()
{
    ...
    public function postNuevo($_nuevoObjeto)
    {
        ...
        $sql = "INSERT INTO equipo_imagen (id, equipo_id, imagen_id) VALUES ($id,'$_nuevoObjeto->equipo_id','$_nuevoObjeto->imagen_id')";
        // echo $sql;
        //ejecutar sql
        $rs = [];
        try {
    ...
    {
        $con = new Conexion();
        $sql = "UPDATE equipo_id SET nombre = '$_nombre' WHERE id = $_id;";
        // echo $sql;
        //ejecutar sql
        $rs = [];
        try {
